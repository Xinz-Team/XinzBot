...
┏┉⌣ ┈̥-̶̯͡..̷̴✽̶┄┈┈┈┈┈┈┈┈┈┈┈┉┓
║         Note :
║${i.owner} : Características del propietario o administrador del grupo
║${i.free} : Funciones gratuitas que no usan límites
║${i.limit} : Funciones que usan 1 límite diario
║${i.glimit} : Funciones que usan el límite de 1 juego
║${i.prem} : Funciones especiales de usuario premium`
┆ 
└┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈⌣
}
